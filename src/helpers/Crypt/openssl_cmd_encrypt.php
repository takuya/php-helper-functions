...
if ( !function_exists( __NAMESPACE__.'\\openssl_cmd_encrypt' ) ) {
  function openssl_cmd_encrypt ( string $data, string $pass, $iter = 1000*1000 ): string {
    $plain_text = file_exists( $data ) ? file_get_contents( $data ) : $data;
    // build command
